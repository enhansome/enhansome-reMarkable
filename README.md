...
# [<img src="Awesome.png"></p>](https://github.com/sindresorhus/awesome) ⭐ 507,375 | 🐛 106 | 📅 2026-09-02
...
* [rmfakecloud](https://github.com/ddvk/rmfakecloud) ⭐ 1,340 | 🐛 64 | 🌐 Go | 📅 2026-07-10 - Fake Cloud Sync, server implementation of the Cloud API.
...
* [rMAPI](https://github.com/ddvk/rmapi) ⭐ 324 | 🐛 20 | 🌐 Go | 📅 2026-08-23 ReMarkable Cloud Go API.
...
* [rmscene](https://github.com/ricklupton/rmscene) ⭐ 153 | 🐛 6 | 🌐 Python | 📅 2026-04-05 - Python library to read v6 files / software version 3.
...
* [KOReader](https://github.com/koreader/koreader) ⭐ 29,769 | 🐛 1,345 | 🌐 Lua | 📅 2026-09-18 - An ebook reader application supporting PDF, DjVu, EPUB, FB2 and many more formats.
...
* [reManager](https://github.com/rmitchellscott/reManager) ⭐ 364 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-03 - Linux, MacOS, and Windows desktop app for managing mods on reMarkable tablets using the [Vellum](https://github.com/vellum-dev/vellum) ⭐ 128 | 🐛 11 | 🌐 Shell | 📅 2026-09-17 package manager.
...
* [rm-xovi-extensions](https://github.com/asivery/rm-xovi-extensions) ⭐ 132 | 🐛 2 | 🌐 C | 📅 2026-09-08 - extensions for the reMarkable tablets, which utilize the xovi framework
...
* [AppLoad](https://github.com/asivery/rm-appload) ⭐ 101 | 🐛 11 | 🌐 C++ | 📅 2026-09-17 - Enables windowed and fullscreen apps inside the reMarkable interface.
...
* [Goosepaper](https://github.com/j6k4m8/goosepaper) ⭐ 342 | 🐛 20 | 🌐 Python | 📅 2026-09-18: Deliver prettily-formatted RSS feeds, news articles, Wikipedia articles-of-the-day, and more to your reMarkable tablet.
