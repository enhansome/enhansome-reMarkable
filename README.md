...
# [<img src="Awesome.png"></p>](https://github.com/sindresorhus/awesome) ⭐ 495,937 | 🐛 100 | 📅 2026-06-30
...
* [rmfakecloud](https://github.com/ddvk/rmfakecloud) ⭐ 1,315 | 🐛 35 | 🌐 Go | 📅 2026-07-10 - Fake Cloud Sync, server implementation of the Cloud API.
...
* [rMAPI](https://github.com/ddvk/rmapi) ⭐ 306 | 🐛 17 | 🌐 Go | 📅 2026-06-01 ReMarkable Cloud Go API.
...
* [libreMarkable](https://github.com/canselcik/libremarkable) ⭐ 699 | 🐛 11 | 🌐 C | 📅 2026-06-16 - A framework for developing applications with native refresh support for reMarkable Tablet.

## Applications

* [KOReader](https://github.com/koreader/koreader) ⭐ 29,010 | 🐛 1,307 | 🌐 Lua | 📅 2026-08-15 - An ebook reader application supporting PDF, DjVu, EPUB, FB2 and many more formats.
...
* [Writerdeck for reMarkable 1](https://github.com/bjornte/Writerdeck-for-reMarkable) ⭐ 2 | 🐛 0 | 🌐 Go | 📅 2026-07-23 - Distraction-free Markdown word processor with keyboard support via a companion app or usb. With optional syncing and encryption of documents.
* [harmony](https://rmkit.dev/apps/harmony) - a low latency sketching app with procedural brushes.

### Browser extensions

* [rePub](https://github.com/hafaio/repub) ⭐ 92 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-13 - unofficial browser extension that creates ePubs from websites and can either upload them to reMarkable cloud or save them locally, currently for Chrome only
* [rePubfox](https://github.com/jrockwar/repubfox) ⭐ 23 | 🐛 5 | 🌐 TypeScript | 📅 2024-11-24 - a hard fork of rePub for Firefox

### Games

* [chessMarkable](https://github.com/LinusCDE/chessmarkable) ⭐ 133 | 🐛 3 | 🌐 Rust | 📅 2025-09-16 - Play chess against a bot or a friend.
...
* [rM-sync](https://github.com/simonschllng/rm-sync) ⭐ 87 | 🐛 6 | 🌐 Shell | 📅 2021-02-26 - Sync script for reMarkable paper tablet.
* [url2epub](https://github.com/fishy/url2epub) ⭐ 81 | 🐛 2 | 🌐 Go | 📅 2026-05-07 - Telegram bot to generate ePub out of URL and send directly to reMarkable Cloud.
* [Moss](https://github.com/RedTTGMoss/moss-desktop) ⭐ 77 | 🐛 6 | 🌐 Python | 📅 2026-08-11 - An app for working with your documents in the reMarkable/rmFakeCloud cloud
...
* [Aviary](https://github.com/rmitchellscott/aviary) ⭐ 57 | 🐛 0 | 🌐 Go | 📅 2026-07-31 - A webhook-driven document uploader for reMarkable Cloud and rmfakecloud, featuring a static UI and a Go backend. Optional integration for email via AWS SES.
* [reMarkable-Sink](http://github.com/hmenzagh/reMarkable-Sink) ⭐ 49 | 🐛 0 | 🌐 JavaScript | 📅 2020-11-21 - Turn a folder into a wormhole to your reMarkable.
...
* [rm-brain](https://github.com/gabrielanhaia/remarkable-brain) ⭐ 6 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-12 - Turns your reMarkable notebooks into a local-first, searchable second brain you query through Claude Desktop.
...
* [latex-yearly-planner](https://github.com/kudrykv/latex-yearly-planner) ⭐ 1,521 | 🐛 22 | 🌐 Go | 📅 2026-05-03 - PDF planner designed for e-ink devices.
...
* [rmtemplate](https://github.com/zer0trip/rmtemplate) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-07-21 - CLI to upload and manage custom templates on reMarkable Paper Pro and Paper Pro Move devices over SSH.
...
* [reManager](https://github.com/rmitchellscott/reManager) ⭐ 336 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-11 - Linux, MacOS, and Windows desktop app for managing mods on reMarkable tablets using the [Vellum](https://github.com/vellum-dev/vellum) ⭐ 114 | 🐛 8 | 🌐 Shell | 📅 2026-08-15 package manager.
...
* [RMHook](https://github.com/NohamR/RMHook) ⭐ 9 | 🐛 0 | 🌐 C++ | 📅 2026-05-13 - A dynamic library injection tool for the reMarkable Desktop macOS application, enabling connection to self-hosted rmfakecloud servers.
* [RMHook-Win](https://github.com/NohamR/RMHook-Win) ⭐ 3 | 🐛 0 | 🌐 C++ | 📅 2026-05-16 - A hooking tool for the reMarkable Desktop Windows application, enabling connection to self-hosted rmfakecloud servers.
* [RMHook-iOS](https://github.com/NohamR/RMHook-iOS/) ⭐ 0 | 🐛 0 | 🌐 Logos | 📅 2026-05-16 - A hooking tool for the reMarkable iOS application, enabling connection to self-hosted rmfakecloud servers.
...
* [rM Hacks](https://github.com/mb1986/rm-hacks) ⭐ 661 | 🐛 166 | 🌐 Shell | 📅 2024-06-11 - Small improvements and tweaks for rM devices.
...
* [AppLoad](https://github.com/asivery/rm-appload) ⭐ 94 | 🐛 12 | 🌐 C++ | 📅 2026-08-14 - Enables windowed and fullscreen apps inside the reMarkable interface.
...
* [xovi-extensions (FouzR)](https://github.com/FouzR/xovi-extensions) ⭐ 88 | 🐛 3 | 📅 2026-07-09
...
* [WebInterface-Wifi](https://github.com/rM-self-serve/webinterface-wifi) ⭐ 44 | 🐛 4 | 🌐 Rust | 📅 2025-02-04 - View the web interface if running, over wifi.
...
* [xovi-qmd-extensions (rmitchellscott)](https://github.com/rmitchellscott/xovi-qmd-extensions) ⭐ 28 | 🐛 3 | 🌐 Shell | 📅 2026-07-20
...
* [rM-signature-patch](https://github.com/Barabazs/rM-signature-patch) ⭐ 23 | 🐛 0 | 🌐 Shell | 📅 2024-03-29 - Simple script to remove that pesky advert at the bottom of a mail originating from a reMarkable.
...
* [rm-hacks-xovi-qmd (Samarkin)](https://github.com/Samarkin/rm-hacks-xovi-qmd) ⭐ 3 | 🐛 0 | 📅 2026-05-11
...
* [reMarkable\_mouse](https://github.com/evidlo/remarkable_mouse) ⭐ 632 | 🐛 29 | 🌐 Python | 📅 2026-05-14 - Use your reMarkable as a graphics tablet.
...
* [Goosepaper](https://github.com/j6k4m8/goosepaper) ⭐ 341 | 🐛 20 | 🌐 Python | 📅 2026-08-13: Deliver prettily-formatted RSS feeds, news articles, Wikipedia articles-of-the-day, and more to your reMarkable tablet.
...
* [rMsync](https://github.com/lschwetlick/rMsync) ⭐ 100 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2022-05-06 - Synchronisation script with a local dedicated "library" folder.
...
* [rM-dl-annotated](https://github.com/jmptable/rm-dl-annotated) ⭐ 85 | 🐛 3 | 🌐 Shell | 📅 2020-10-04 - Export annotated PDFs from reMarkable tablets.
* [reSnap](https://github.com/cloudsftp/reSnap) ⭐ 79 | 🐛 4 | 🌐 Shell | 📅 2026-01-28 - Take snapshots of your reMarkable screen over SSH.
* [reMarkable-touchgestures](https://github.com/ddvk/remarkable-touchgestures) ⭐ 69 | 🐛 2 | 🌐 C | 📅 2020-12-21 - Touch gestures (swipe/touch) for easy page navigation.
...
* [remarks](https://github.com/Scrybbling-together/remarks) ⭐ 62 | 🐛 19 | 🌐 Python | 📅 2026-08-13 - Extract highlights, scribbles, and annotations from PDFs. Export to Markdown, PNG, and SVG.
...
* [remarkable-ssh](https://github.com/Penguin-Guru/remarkable-ssh) ⭐ 5 | 🐛 0 | 🌐 Shell | 📅 2026-03-05 - A bash script to manage files on reMarkable devices via CLI and SSH.
...
* [reStream](https://github.com/rien/reStream) ⭐ 863 | 🐛 10 | 🌐 Shell | 📅 2026-06-10 - Stream your reMarkable screen over SSH.
...
* [goMarkableStream](https://github.com/owulveryck/goMarkableStream) ⭐ 745 | 🐛 26 | 🌐 Go | 📅 2026-04-18 - Stream the screen of the reMarkable 2 (FW 2.5) easily (client/server in Go with no installation) along with the colors (with FW > 2.11.x).
* [VNSee](https://github.com/matteodelabre/vnsee) ⭐ 298 | 🐛 24 | 🌐 C++ | 📅 2021-08-29 - VNC client for the reMarkable tablet allowing you to use the device as a second screen.
