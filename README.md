...
# [<img src="Awesome.png"></p>](https://github.com/sindresorhus/awesome) ⭐ 507,030 | 🐛 106 | 📅 2026-09-02
...
* [rmfakecloud](https://github.com/ddvk/rmfakecloud) ⭐ 1,341 | 🐛 63 | 🌐 Go | 📅 2026-07-10 - Fake Cloud Sync, server implementation of the Cloud API.
...
* [libreMarkable](https://github.com/canselcik/libremarkable) ⭐ 703 | 🐛 11 | 🌐 C | 📅 2026-06-16 - A framework for developing applications with native refresh support for reMarkable Tablet.

## Applications

* [KOReader](https://github.com/koreader/koreader) ⭐ 29,760 | 🐛 1,344 | 🌐 Lua | 📅 2026-09-17 - An ebook reader application supporting PDF, DjVu, EPUB, FB2 and many more formats.
...
* [Syncthing-for-reMarkable-AppLoad](https://github.com/paviro/Syncthing-for-reMarkable) ⭐ 14 | 🐛 0 | 🌐 Rust | 📅 2026-06-07 - Syncthing appload app for reMarkable (incl. Paper Pro and Paper Pro Move).
...
* [reManager](https://github.com/rmitchellscott/reManager) ⭐ 364 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-03 - Linux, MacOS, and Windows desktop app for managing mods on reMarkable tablets using the [Vellum](https://github.com/vellum-dev/vellum) ⭐ 128 | 🐛 10 | 🌐 Shell | 📅 2026-09-16 package manager.
...
* [Goosepaper](https://github.com/j6k4m8/goosepaper) ⭐ 344 | 🐛 19 | 🌐 Python | 📅 2026-09-10: Deliver prettily-formatted RSS feeds, news articles, Wikipedia articles-of-the-day, and more to your reMarkable tablet.
