...
# [<img src="Awesome.png"></p>](https://github.com/sindresorhus/awesome) ⭐ 497,176 | 🐛 104 | 📅 2026-06-30
...
* [rMAPI](https://github.com/ddvk/rmapi) ⭐ 307 | 🐛 20 | 🌐 Go | 📅 2026-06-01 ReMarkable Cloud Go API.
...
* [KOReader](https://github.com/koreader/koreader) ⭐ 29,091 | 🐛 1,308 | 🌐 Lua | 📅 2026-08-18 - An ebook reader application supporting PDF, DjVu, EPUB, FB2 and many more formats.
...
* [reManager](https://github.com/rmitchellscott/reManager) ⭐ 339 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-11 - Linux, MacOS, and Windows desktop app for managing mods on reMarkable tablets using the [Vellum](https://github.com/vellum-dev/vellum) ⭐ 116 | 🐛 8 | 🌐 Shell | 📅 2026-08-17 package manager.
...
* [xovi-extensions (FouzR)](https://github.com/FouzR/xovi-extensions) ⭐ 88 | 🐛 4 | 📅 2026-07-09
...
* [Goosepaper](https://github.com/j6k4m8/goosepaper) ⭐ 343 | 🐛 21 | 🌐 Python | 📅 2026-08-13: Deliver prettily-formatted RSS feeds, news articles, Wikipedia articles-of-the-day, and more to your reMarkable tablet.
...
* [VNSee](https://github.com/matteodelabre/vnsee) ⭐ 299 | 🐛 24 | 🌐 C++ | 📅 2021-08-29 - VNC client for the reMarkable tablet allowing you to use the device as a second screen.
