...
# [<img src="Awesome.png"></p>](https://github.com/sindresorhus/awesome) ⭐ 504,716 | 🐛 106 | 📅 2026-09-02
...
* [rmfakecloud](https://github.com/ddvk/rmfakecloud) ⭐ 1,336 | 🐛 52 | 🌐 Go | 📅 2026-07-10 - Fake Cloud Sync, server implementation of the Cloud API.
...
* [rMAPI](https://github.com/ddvk/rmapi) ⭐ 315 | 🐛 20 | 🌐 Go | 📅 2026-08-23 ReMarkable Cloud Go API.
...
* [rmscene](https://github.com/ricklupton/rmscene) ⭐ 153 | 🐛 4 | 🌐 Python | 📅 2026-04-05 - Python library to read v6 files / software version 3.
...
* [librm\_lines](https://github.com/RedTTGMoss/librm_lines) ⭐ 9 | 🐛 2 | 🌐 C++ | 📅 2026-09-02 - A C++ library for reading & writing & rendering v6 files with the original reMarkable quill library, includes multiple languages wrappers for python and npm.

### Other APIs

* [libreMarkable](https://github.com/canselcik/libremarkable) ⭐ 701 | 🐛 11 | 🌐 C | 📅 2026-06-16 - A framework for developing applications with native refresh support for reMarkable Tablet.

## Applications

* [KOReader](https://github.com/koreader/koreader) ⭐ 29,624 | 🐛 1,341 | 🌐 Lua | 📅 2026-09-10 - An ebook reader application supporting PDF, DjVu, EPUB, FB2 and many more formats.
...
* [darvin/plato](https://github.com/darvin/plato) ⭐ 125 | 🐛 8 | 🌐 Rust | 📅 2019-01-12 [LinusCDE/plato](https://github.com/LinusCDE/plato) ⭐ 53 | 🐛 4 | 🌐 Rust | 📅 2025-09-17 - Plato reader port. Supports pdfs, epubs, many other formats.
...
* [Writerdeck for reMarkable 1](https://github.com/bjornte/Writerdeck-for-reMarkable) ⭐ 2 | 🐛 0 | 🌐 Go | 📅 2026-09-08 - Distraction-free Markdown word processor with keyboard support via a companion app or usb. With optional syncing and encryption of documents.
* [harmony](https://rmkit.dev/apps/harmony) - a low latency sketching app with procedural brushes.

### Browser extensions

* [rePub](https://github.com/hafaio/repub) ⭐ 92 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-02 - unofficial browser extension that creates ePubs from websites and can either upload them to reMarkable cloud or save them locally, currently for Chrome only
* [rePubfox](https://github.com/jrockwar/repubfox) ⭐ 23 | 🐛 5 | 🌐 TypeScript | 📅 2024-11-24 - a hard fork of rePub for Firefox

### Games

* [chessMarkable](https://github.com/LinusCDE/chessmarkable) ⭐ 136 | 🐛 3 | 🌐 Rust | 📅 2025-09-16 - Play chess against a bot or a friend.
...
* [DOOMarkable](https://github.com/LinusCDE/doomarkable) ⭐ 53 | 🐛 2 | 🌐 Rust | 📅 2025-09-16 - Play DOOM on the reMarkable 1.
...
* [draft-reMarkable](https://github.com/dixonary/draft-reMarkable) ⭐ 154 | 🐛 17 | 🌐 C++ | 📅 2022-02-09 - A launcher for the reMarkable tablet, which wraps around the standard interface.
...
* [Aviary](https://github.com/rmitchellscott/aviary) ⭐ 59 | 🐛 0 | 🌐 Go | 📅 2026-08-26 - A webhook-driven document uploader for reMarkable Cloud and rmfakecloud, featuring a static UI and a Go backend. Optional integration for email via AWS SES.
...
* [rm-brain](https://github.com/gabrielanhaia/remarkable-brain) ⭐ 9 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-09 - Turns your reMarkable notebooks into a local-first, searchable second brain you query through Claude Desktop.
...
* [latex-yearly-planner](https://github.com/kudrykv/latex-yearly-planner) ⭐ 1,527 | 🐛 22 | 🌐 Go | 📅 2026-05-03 - PDF planner designed for e-ink devices.
...
* [reMarkable-bujo](https://github.com/vonneudeck/remarkable-bujo) ⭐ 59 | 🐛 0 | 📅 2025-02-20 - "Bullet Journal" templates.
...
* [reManager](https://github.com/rmitchellscott/reManager) ⭐ 361 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-03 - Linux, MacOS, and Windows desktop app for managing mods on reMarkable tablets using the [Vellum](https://github.com/vellum-dev/vellum) ⭐ 126 | 🐛 9 | 🌐 Shell | 📅 2026-09-10 package manager.
...
* [rm-xovi-extensions](https://github.com/asivery/rm-xovi-extensions) ⭐ 130 | 🐛 2 | 🌐 C | 📅 2026-09-08 - extensions for the reMarkable tablets, which utilize the xovi framework
...
* [AppLoad](https://github.com/asivery/rm-appload) ⭐ 100 | 🐛 9 | 🌐 C++ | 📅 2026-09-08 - Enables windowed and fullscreen apps inside the reMarkable interface.
* [xovi-extensions (FouzR)](https://github.com/FouzR/xovi-extensions) ⭐ 91 | 🐛 3 | 📅 2026-09-07
...
* [xovi-tripletap](https://github.com/rmitchellscott/xovi-tripletap) ⭐ 37 | 🐛 2 | 🌐 Shell | 📅 2026-05-12 - Start xovi with a triple-press of the power button.
* [xovi-qmd-extensions (ingatellent)](https://github.com/ingatellent/xovi-qmd-extensions) ⭐ 29 | 🐛 1 | 🌐 QML | 📅 2026-09-05
...
* [xovi-qmd-extensions (rmitchellscott)](https://github.com/rmitchellscott/xovi-qmd-extensions) ⭐ 29 | 🐛 3 | 🌐 Shell | 📅 2026-09-02
...
* [reMarkable\_mouse](https://github.com/evidlo/remarkable_mouse) ⭐ 634 | 🐛 28 | 🌐 Python | 📅 2026-08-15 - Use your reMarkable as a graphics tablet.
...
* [Goosepaper](https://github.com/j6k4m8/goosepaper) ⭐ 342 | 🐛 18 | 🌐 Python | 📅 2026-09-09: Deliver prettily-formatted RSS feeds, news articles, Wikipedia articles-of-the-day, and more to your reMarkable tablet.
...
* [rmirro](https://github.com/hersle/rmirro) ⭐ 126 | 🐛 7 | 🌐 Python | 📅 2025-01-12 - A script that synchronizes PDFs of documents between a Remarkable and a computer folder that mirrors its file structure without cloud access.
...
* [rmathlab](https://github.com/Samdney/rmathlab) ⭐ 12 | 🐛 0 | 🌐 Python | 📅 2025-03-07 - A Linux toolset for the reMarkable 2 tablet, which enables math handwriting recognition and LaTeX generation over USB via Mathpix.
...
* [reStream](https://github.com/rien/reStream) ⭐ 866 | 🐛 10 | 🌐 Shell | 📅 2026-06-10 - Stream your reMarkable screen over SSH.
...
* [goMarkableStream](https://github.com/owulveryck/goMarkableStream) ⭐ 749 | 🐛 28 | 🌐 Go | 📅 2026-08-21 - Stream the screen of the reMarkable 2 (FW 2.5) easily (client/server in Go with no installation) along with the colors (with FW > 2.11.x).
* [VNSee](https://github.com/matteodelabre/vnsee) ⭐ 302 | 🐛 24 | 🌐 C++ | 📅 2021-08-29 - VNC client for the reMarkable tablet allowing you to use the device as a second screen.
